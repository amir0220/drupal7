 ...
 */
function drupal7_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['drupal7_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('drupal7_theme sample setting'),
  '#default_value' => theme_get_setting('drupal7_theme_example'),
